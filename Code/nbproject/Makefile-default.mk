...
SOURCEFILES_QUOTED_IF_SPACED=ECU/DC_Motor/ecu_dcMotor.c MCAL/GPIO/hal_gpio.c project.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1 ${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1 ${OBJECTDIR}/project.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1.d ${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1.d ${OBJECTDIR}/project.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1 ${OBJECTDIR}/MCAL/GPIO/hal_gpio.p1 ${OBJECTDIR}/project.p1

# Source Files
SOURCEFILES=ECU/DC_Motor/ecu_dcMotor.c MCAL/GPIO/hal_gpio.c project.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1: ECU/DC_Motor/ecu_dcMotor.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/ECU/DC_Motor" 
	@${RM} ${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1.d 
	@${RM} ${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1 ECU/DC_Motor/ecu_dcMotor.c 
	@-${MV} ${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.d ${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/ECU/DC_Motor/ecu_dcMotor.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
