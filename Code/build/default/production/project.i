...
# 32 "./ECU/DC_Motor/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 12 "./ECU/DC_Motor/ecu_dcMotor.h" 2
# 21 "./ECU/DC_Motor/ecu_dcMotor.h"
typedef struct{
    uint8 Port: 4;
    uint8 Pin: 3;
    uint8 Status: 1;
...
void main(void) {
    ...
    while(1){
        ...
        _delay((unsigned long)((100)*(80000000UL/4000.0)));
